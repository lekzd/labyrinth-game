...
const timePointsConfig: Record<number, EnvironmentPointConfig> = {
  ...
  [time(8, 0)]: {
    ...
    lightIntensity: 1.0,
    skyColor: new Color('#2fbae8'),
    fogColor: new Color('#063e08'),
  ...
  [time(10, 0)]: {
    ...
    lightIntensity: 1.0,
    skyColor: new Color('#2f72e8'),
    fogColor: new Color('#063e22'),
